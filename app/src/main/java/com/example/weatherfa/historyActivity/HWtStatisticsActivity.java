...
public class HWtStatisticsActivity extends AppCompatActivity {
    ...
    private void initUI() {
        ...
        ld=new LoadingDialog(HWtStatisticsActivity.this);
        //组件初始化
            ...
            public void run() {
                ...
                okHttpClient.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                        ...
                        if (responseStr.contains("200")) { //Response{protocol=http/1.1, code=200, message=, url=...}
                                ...
                                if (success == 1) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            AlertDialog.Builder builder = new AlertDialog.Builder(HWtStatisticsActivity.this);
                                            builder.setTitle("提示");
